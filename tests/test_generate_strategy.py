...
@pytest.mark.parametrize(
    ...
    [
        ((1,), [1]), (("1",), ["1"]), (("www.test.com",), ["www.test.com"]), ((True,), [True]), ((None,), [None]),
        (([1],), [[1]]), ((["test"],), [["test"]]), (([["test"]],), [[["test"]]]), (([True],), [[True]]),
        (([1, 2],), [[1, 2]]), (([1], 2), [[1], 2]), (("1", 2), ["1", 2]), ((["1"], 2), [["1"], 2]),
        ((True, False), [True, False]), (([True, False],), [[True, False]]), ((1, 2, 3), [1, 2, 3]),
        ((1, 2, [3]), [1, 2, [3]]), (([1], [2], [3]), [[1], [2], [3]]), (('1', '2', '3'), ['1', '2', '3']),
        ((1, 2, '+'), [[2, 1]]), (([1], 2, '+',
                                  ), [[1, 2]]), (("1", 2, '+'), [[2, "1"]]), ((True, "False", '+'), [["False", True]]),
        (([1], [2], '+'), [[2, [1]]]),
    ]
)
...
@pytest.mark.parametrize(
    "pattern, expected_result",
    [
        (('#ADD_DATASET#GET#digits$', '@'), digits), (('#ADD_DATASET #GET#digits$', '@'), digits),
        (('#ADD_DATASET#GET #digits$', '@'), digits), (('#ADD_DATASET #GET #digits$', '@'), digits),
        ((1, '#ADD_DATASET#GET#digits$', '+', '@'), [1, 2, 3, 0.01, 1]), (("1", [4, 5, 6], '+', '@'), [4, 5, 6, '1']),
        (("1", '#ADD_DATASET#GET#strings$', '+', '@'), ['4', '5', '6', '1']),
        ((0, '#ADD_DATASET#GET#bls$', '+', '@'), [True, False, 0]), ((1, '#APPLY#LIST_IT#list_once$'), [[1]]),
        ((1, '#APPLY #LIST_IT#list_once$'), [[1]]), ((1, '#APPLY#LIST_IT #list_once$'), [[1]]),
        ((1, '#APPLY #LIST_IT #list_once$'), [[1]]), ((1, '#APPLY#LIST_IT#list_several_times#2$'), [[[1]]]),
